...
def test_monitor_load_model_fallback():
    ...
    with patch("gpudefrag.scheduler.monitor.FragPredictor.load", side_effect=Exception("Load fail")), \
         patch("gpudefrag.scheduler.monitor.FragPredictor.from_config", return_value=mock_predictor), \

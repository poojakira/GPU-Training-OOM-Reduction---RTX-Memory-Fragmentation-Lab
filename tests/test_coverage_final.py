...
from gpudefrag.defrag_engine.benchmark_triton import run_benchmark
...
def test_defragmenter_triton_repack_branch():
    ...
    with patch("torch.cuda.is_available", return_value=True), \
         patch("gpudefrag.defrag_engine.defragmenter.triton_compaction_copy") as mock_kernel, \
        ...
        with patch("gpudefrag.defrag_engine.defragmenter.HAS_TRITON", True):
...
def test_benchmark_triton_mocked():
    ...
    import gpudefrag.defrag_engine.benchmark_triton as benchmark_triton
    ...
    with patch("torch.cuda.is_available", return_value=True), \
         patch("gpudefrag.defrag_engine.benchmark_triton.TRITON_AVAILABLE", True), \
         patch("gpudefrag.defrag_engine.benchmark_triton.triton_compaction_copy") as mock_triton, \
         patch("gpudefrag.defrag_engine.benchmark_triton.torch.randn"), \
         patch("gpudefrag.defrag_engine.benchmark_triton.torch.empty_like"), \
         patch("gpudefrag.defrag_engine.benchmark_triton.torch.cuda.synchronize"):
